 ...
 * @returns {String}
 */
String.prototype.align = function (align, length, ch = ' ') {
    let s = this;
    switch (align) {
        case 'left':
            return s.padEnd(length, ch);
        case 'right':
            return s.padStart(length, ch);
    }
